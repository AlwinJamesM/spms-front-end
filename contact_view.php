<head>
	...
	<head>
		...
		<title>Contact Us | Porto - Multipurpose Website Template</title>	
		...
		<!-- Web Fonts  -->
		<link id="googleFonts" href="<?php echo base_url(); ?>/spms/porto/assets/https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800%7CShadows+Into+Light&display=swap" rel="stylesheet" type="text/css">
		...
		<div class="row py-4">
			<div class="col-lg-6">
				...
				<div class="center alert alert-danger">
					<i class="icon-warning-sign"></i> We are not affiliated with <strong>St. Patrick's Clinic and Laboratory</strong>. The said establishment is permanently closed. <a href="https://spms.com.ph/clinic.html" target="_blank">Click here</a> to learn more
				</div>

				<form class="nobottommargin" id="template-contactform" name="template-contactform" action="<?php echo base_url(); ?>inquiry/send_contacts" method="post">
					...
					<div class="col_half col_last">
						...
						<input type="text" id="template-contactform-area" name="template-contactform-area" value="" class="required sm-form-control" />
					</div>
			...
			<div class="col-lg-6">
				...
				<?php
					...
					<ul class="list list-icons list-icons-style-2 mt-2">
						...
						<li><i class="fas fa-envelope top-6"></i> <strong class="text-dark">Email:</strong> <a href="mailto:mail@example.com">spmsphilippines@gmail.com</a></li>
					</ul>
				</div>

...
<section
    ...
    style="background-image: url(img/bg-myray.jpg);">
    <div class="container">
        <div class="row mt-5">
        ...
        <div class="col">
                ...
                <div class="col-md-9 mx-md-auto">
                    ...
                    <div class="overflow-hidden mb-3">
                        <p class="lead mb-0 appear-animation" data-appear-animation="maskUp"
                            ...
                            Since 1989, St. Patrick's Medical Systems (SPMS) has been "Nurturing Growth Solutions" for
                            the healthcare organizations we deliberately serve.
                            We empower our organization to continuously be better in achieving our objective by
                            embracing:
                        </p>
                    </div>
                </div>
            ...
            <div class="row mt-3 mb-5">
                ...
                <div class="col-md-4 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="600">
                    ...
                    <p>Enabling a successful healthcare practice through better customer solutions and employee
                        excellence.</p>
                </div>

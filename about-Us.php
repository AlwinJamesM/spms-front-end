...
<section class="page-header page-header-modern page-header-background page-header-background-md overlay overlay-color-dark overlay-show overlay-op-7" style="background-image: url(img/bg-myray.jpg);">
    <div class="container">
        <div class="row mt-5">
                ...
                <div class="col-md-9 mx-md-auto">
                    ...
                    <div class="overflow-hidden mb-3">
                        <p class="lead mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">
                            Since 1989, St. Patrick's Medical Systems (SPMS) has been "Nurturing Growth Solutions" for the healthcare organizations we deliberately serve.
                            We empower our organization to continuously be better in achieving our objective by embracing:
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row counters counters-sm pb-4 pt-3">
            ...
            <div class="col-sm-6 col-lg-3 mb-5 mb-sm-0">
                <div class="counter">
                    ...
                    <label class="text-4 mt-1 text-color-light">Ratings</label>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="counter">
                    <i class="fa-regular fa-user text-color-light"></i>
                    <strong class="text-color-light font-weight-extra-bold" data-to="300" data-append="+">0</strong>

...
<head>
	...
	<?php } else if($title == 'careers-form') { ?>
		<style>
    .responsive-iframe {
        position: relative;
        width: 900px;
    ...
    .container-fluid {
        padding: 0 12px;
        /* Adjust padding to control the spacing */
        margin: 0 auto;
									...
									<div
										...
										<nav class="collapse">
											<ul class="nav nav-pills" id="mainNav">
												...
												<li class="dropdown">
													<a class="dropdown-item <?php echo isPageActive('about-Us.php'); ?>"
														data-hash data-hash-offset="0" data-hash-offset-lg="90"
														href="about-Us.php">About Us</a>
												</li>
												<li class="dropdown">
													<a class="dropdown-item <?php echo isPageActive('products.php'); ?>"
														data-hash data-hash-offset="0" data-hash-offset-lg="90"
														href="products.php">Products</a>
												</li>
												<li class="dropdown">
													<a class="dropdown-item <?php echo isPageActive('blogs.php'); ?>"
														data-hash data-hash-offset="0" data-hash-offset-lg="90"
														href="blogs.php">Blogs</a>
												</li>
												<li class="dropdown">
													<a class="dropdown-item <?php echo isPageActive('careers.php'); ?>"
														data-hash data-hash-offset="0" data-hash-offset-lg="90"
														href="careers.php">Careers</a>
												</li>
												<li class="dropdown">
													<a class="dropdown-item <?php echo isPageActive('contact-Us.php'); ?>"
														data-hash data-hash-offset="0" data-hash-offset-lg="90"
